...
func (s *usecase) List(params ListParams) ([]ModemLogRaw, error) {
	return s.repo.List(params)
}

func (s *usecase) ListTelemetry(params ListParams) ([]Telemetry, error) {
	return s.repo.ListTelemetry(params)
}
